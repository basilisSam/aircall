import {Avatar, Badge, Button, Flex, Spacer, Typography} from "@aircall/tractor";
...
const Navbar = () => {
    ...
    return <Flex bg="primary.light" color="base.white" alignItems="center" justifyContent="center" p={3}>
